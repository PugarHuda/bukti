    ...
    <>
      ...
      <div className="card card-pad">
        <p className="hint" style={{ margin: 0 }}>
          The honest read: the metric, its completeness, and the <strong>authenticity of the underlying chain data</strong> are all proven on-chain. Since we last published this table we closed <strong>five</strong> of our own gaps with running code — wash-trading (fee-aware score, Spearman −0.28), open-position <strong>mark-to-market</strong> ($37 hidden exposure surfaced), <strong>identity-binding</strong> (EIP-191, adversary rejected), <strong>oracle confidence/staleness</strong> (4/4 feeds inside a 50 bps band), and <strong>funder-graph anti-sybil</strong> (18 sybil wallets collapse → 87 distinct identities) — each runnable via <code>npm&nbsp;run&nbsp;…</code> — and widened the venue coverage from 2 to 49 pools. What honestly remains is a third-party audit. A verifiability project should name its own boundary — and then keep moving it.
        </p>
      </div>
    </>
  );
